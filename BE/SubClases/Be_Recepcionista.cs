...
{
    public class Be_Recepcionista : Be_Usuario
    {
        public Be_Recepcionista(string dni, string nombre, string apellido, string email,
                                string nombreusuario, string rol, bool bloq)
            : base(dni, nombre, apellido, email, nombreusuario, rol, bloq) { }

        public Be_Recepcionista(string apellido, string contraseña, string dni, string email,
