...
namespace BE.SubClases
{
    ...
    {
        public Be_Administrador(string dni, string nombre, string apellido, string email,
                                string nombreusuario, string rol, bool bloq)
            : base(dni, nombre, apellido, email, nombreusuario, rol, bloq)
        { }

        public Be_Administrador(string apellido, string contraseña, string dni, string email,
